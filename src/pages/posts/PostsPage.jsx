...
const PostsPage = () => {
    ...
    // שינוי: fetchUrl כעת מצביע לכתובת הכללית כדי להביא את הפוסטים של כולם
    ...
    const handleSave = async (formData) => {
        if (modalConfig.type === 'add') {
            await addItem({
                userId: currentUser.id, // הפוסט החדש עדיין משויך למשתמש הנוכחי
    ...
    return (
        <div className="postsContainer">
            {/* שינוי קטן בכותרת כדי לשקף את המצב החדש */}
